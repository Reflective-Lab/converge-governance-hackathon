...
printf 'Project:     Converge Governance Hackathon\n'
printf 'Build:       %s\n\n' "$build_status"
...
- Read kb/Architecture/Overview.md
- Read kb/Domain/Vendor Selection.md
- Read kb/Development/Getting Started.md
- Read kb/Workflow/Working with Codex.md or kb/Workflow/Working with Claude.md
EOF
else
