...
- Auth/authz bypasses
- Unsafe code (zero tolerance in this project)
...
- Typed enums, not strings with semantics
- Agents propose facts, never create them directly

**Operations**
- Does it break the build? (`just check && just lint`)
